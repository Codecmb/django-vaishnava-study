...
# Replace ONLY the form field line with multiple choice options
old_line = '                                    {{ form|get_field:question.id }}'

new_content = '''                                    <div class="choice-options">
...
print("✓ Replaced only the form field with multiple choice - kept everything else")
