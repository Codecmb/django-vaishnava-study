#!/usr/bin/env python3
"""
Fix template syntax errors with proper escaping
"""
...
'''
    ...
    # 2. Update instructions - FIXED: Use proper escaping
    if '💡' not in content:
    ...
    # 3. Replace the question section - FIXED: Remove problematic trans tags with apostrophes
    ...
    # 4. Add JavaScript - FIXED: Remove problematic trans tags in JavaScript
...
'''
    ...
    print("✓ Template fixed with proper syntax")
